...
def prepisi_in_zagrozi(ime_datoteke, nova_datoreka):
...
#     ['nepoliticno.txt']
# =============================================================================
def groznje_z_dovolj_klicaji(seznam):  #edini parameter je seznam, ki vsebuje imena datotek
    rezultat = []
    for datoteka in seznam:
        with open(datoteka, "r", encoding="utf-8") as vhod:
            if vhod.read().count("!") >= 3:
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDM0NiwidXNlciI6MTE2MjR9:1wGF4u:XjVhvhpNfNMOiIxssVZIgIgEBPgVwWEPNe_OKXfsUGY"
        try:
            test_cases = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDM0NywidXNlciI6MTE2MjR9:1wGF4u:Rmm1MeNku_pUIAMlYBS4fFIydYyFtVWIGDKeAiQTaA0"
        try:
            test_cases = [
