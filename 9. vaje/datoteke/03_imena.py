...
def koliko(niz, datoteka):
    ...
    with open(datoteka, "w", encoding="utf-8") as izhod:
        for ime in razlicna_imena:
            print(ime, vsa_imena.count(ime), file = izhod)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNTEwLCJ1c2VyIjoxMTYyNH0:1wGF4u:csQtOGh-D-cIPJvP7tjP-rA71mb-jgfjkKUSiOSDfjc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNTExLCJ1c2VyIjoxMTYyNH0:1wGF4u:0LfFaNskTnRwnjeZ57Dr7600lCKu-OL3D7ydujYyBXQ"
        try:
            test_cases = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNTEyLCJ1c2VyIjoxMTYyNH0:1wGF4u:oxZAuwxzm1Jk6LG9Xq8vDC9EvTG2Y1bjfQfUuvvt-A0"
        try:
            test_cases = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNTEzLCJ1c2VyIjoxMTYyNH0:1wGF4u:K-pVASG84hQYk6nRYN89hUcgpNhBIwAHyGwoTxgq43Y"
        try:
            test_cases = [
