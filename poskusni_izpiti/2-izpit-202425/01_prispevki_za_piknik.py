...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk5NywidXNlciI6MTE2MjR9:1wWgeJ:DA1m0hSoID5Ll50W7kqylYCa4uPhgYbScaJvzuUXAkQ"
        try:
            prispevki1 = {}
            prispevki2 = {"Cene": {}}
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk5OSwidXNlciI6MTE2MjR9:1wWgeK:mZ0Jnz3Y2uboI8UnG4M_pt1-o6hG3BmMjiigtbqV8_o"
        try:
            prispevki1 = {}
            prispevki2 = {"Cene": {}}
            prispevki3 = {"Alenka": {"radler": 3}, "Bojan": {"radler": 4}}
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAwMCwidXNlciI6MTE2MjR9:1wWgeK:CDN_2mOXXjmxRIlBP9H38EQdillCeNIf-3ZlmCcwFSs"
        try:
            rezultat1 = {
                "Alenka": 1.7,
                "Cene": 11.9,
