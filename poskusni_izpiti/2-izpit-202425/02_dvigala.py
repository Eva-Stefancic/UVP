...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk5MywidXNlciI6MTE2MjR9:1wWgeK:j7LXCM2gBOHWynNYIOkNv6ylfsKFQsEiILAexJ8-MtY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk5NCwidXNlciI6MTE2MjR9:1wWgeK:J-xTwVy_xaZRyKUVbKKxI_atVXtatRDUAn1boqz23M0"
        try:
            podatki = [
                (3, [1, 5, 0, 4], 2, 17),
                (3, [], 3, 0),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk5NSwidXNlciI6MTE2MjR9:1wWgeK:0eW15ShW27buCTwsl8PKGtTtijnebGBrmArVgfUhCGY"
        try:
            podatki = [
