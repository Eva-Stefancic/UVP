...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk4MiwidXNlciI6MTE2MjR9:1wWgeK:dLpd6AYzGrdrWXIMZrR_MHa1GJfhBBd6v1BbGI8mXWo"
        try:
            tests = [
                (['3,3,v,3'], 3, [[' ', ' ', ' '], [' ', ' ', ' '], [' ', ' ', ' ']]),
                (['3,3,v,3', '1,2,>,2'], 3, [[' ', '#', '#'], [' ', ' ', ' '], [' ', ' ', ' ']]),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk4NCwidXNlciI6MTE2MjR9:1wWgeK:vpM6JJEudF6Vbyg7XQGwxkUOsKb3LtghSdRhowtuLAQ"
        try:
            tests = [
                ([[' ', ' ', ' '], [' ', ' ', ' '], [' ', ' ', ' ']], "/---\\\n|   |\n|   |\n|   |\n\\---/"),
                ([[' ', '#', '#'], [' ', ' ', ' '], [' ', ' ', ' ']], "/---\\\n| ##|\n|   |\n|   |\n\\---/"), 
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjk4MywidXNlciI6MTE2MjR9:1wWgeK:V6STHtEbWVScFdDq1J91a1vU_k7Ihhm9M1Sq3uAKHro"
        try:
            tests = [
                (['5,5'], ['3,3,v,3'], 3, [[' ', ' ', ' '], [' ', ' ', ' '], [' ', ' ', ' ']]),
                (['5,2', '2,5'], ['3,3,v,3'], 3, [[' ', ' ', ' '], [' ', ' ', ' '], [' ', ' ', ' ']]),
