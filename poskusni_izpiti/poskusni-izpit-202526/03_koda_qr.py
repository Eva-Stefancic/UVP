...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0NDc1NCwidXNlciI6MTE2MjR9:1wWgbW:SSj85Is0xyjcW7E5Hz4jsk7pkM0WY8Z0YVHzt_69Khs"
        try:
            env = {'qr': KodaQR(3, 4)}
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0NDc1NSwidXNlciI6MTE2MjR9:1wWgbW:Le4py6g8RTOuuq2xzA2PWsVzmTphVzjz4sO8hcMbmZo"
        try:
            qr = KodaQR(3, 4)
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0NDc1NiwidXNlciI6MTE2MjR9:1wWgbW:MRONuX1FS2lg19RYk1rStJJGaSQYdOXaRCqV02QQVww"
        try:
            qr = KodaQR(3, 4)
            qr.vzorec([[0, 1], [1, 0]], 1, 1)
