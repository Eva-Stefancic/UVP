...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyMSwidXNlciI6MTE2MjR9:1wWgfm:J6tvZKH-Z2iXpNlEr8GYIt6zOcq2YUq2f_GYoSqTNk8"
        try:
            testni_primeri = [
                ('ATGGCTA', 'TACCGAT'),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyMCwidXNlciI6MTE2MjR9:1wWgfm:t1_40R2zDvT-L-gTEt11apLJdzGrDL9fswuVhgUdX3M"
        try:
            testni_primeri = [
                ('ATGGCTA', 0, ['ATG', 'GCT']),
                ('ATGGCTA', 1, ['TGG', 'CTA']),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyMiwidXNlciI6MTE2MjR9:1wWgfm:sEFsLQ0ZEIBVOFjWCb3kxPwle86UcKinwuDvyQ3yIH8"
        try:
            testni_primeri = [
                (['ATG', 'TAA'], ['ATG', 'TAA']),
                (['ATG', 'TAG'], ['ATG', 'TAG']),
