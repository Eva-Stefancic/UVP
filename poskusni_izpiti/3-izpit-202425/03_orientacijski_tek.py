...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyNiwidXNlciI6MTE2MjR9:1wWgfm:Uv4Tab2wePash4R2XvBH6mF3kzIQNaOLfZPalhLvZg0"
        try:
            proga1 = ["START", "A", "B", "E", "CILJ"]
            proga2 = ["START", "A", "C", "D", "E", "CILJ"]
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyNywidXNlciI6MTE2MjR9:1wWgfm:9hSkn8DawP7nw_89C3vxKmtVP5ZDgExM7oQpgPHQUec"
        try:
            proga1 = ["START", "A", "B", "E", "CILJ"]
            tekmovalci1 = [
                [("START", 0), ("A", 5), ("B", 6), ("E", 10), ("CILJ", 11)],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0NDMzMiwidXNlciI6MTE2MjR9:1wWgfm:ZBNiwvM09V543M4WGNLhN1N_dWagu968pIOGqhhC8zc"
        try:
            testi = [
