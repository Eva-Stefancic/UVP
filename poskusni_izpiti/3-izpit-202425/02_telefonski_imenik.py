...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyMywidXNlciI6MTE2MjR9:1wWgfm:JT6OCo-vj0U0j-bi3VJWqI-xz5mTLI7lk5g3WEgjjhw"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyNCwidXNlciI6MTE2MjR9:1wWgfm:V6k8kGO-hRegi4HDNXlVBJHrIA22SCRhwe9Ii3dA7M8"
        try:
            Check.run(
                [
                    'i = Imenik()',
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MzAyNSwidXNlciI6MTE2MjR9:1wWgfm:ywrnl-gXJBNbjda7Tvic1Fuwanvn6f0jPx-GDOY1C6A"
        try:
            Check.run(
                [
                    'i = Imenik()',
