...
def vsota_prvih(n):       
    i = 0                 # Spremenljivki i nastavimo začetno vrednost 0.
    vsota = 0             # Ustvarimo spremenljivko, v katero bomo shranjevali vsoto.
    for i in range(n+1):  # Z zanko gremo skozi vsa števila od 0 do n.
        vsota += i        # Trenutno vrednost i prištejemo k vsoti.
    return vsota          # Funkcija vrne vsoto vseh števil od 0 do n.
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NzgsInVzZXIiOjExNjI0fQ:1w3ZC0:zdj-Nsjru7FHYupnCM06h72HxypMfJNtZym_ofNChzc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NzksInVzZXIiOjExNjI0fQ:1w3ZC0:qMvDuf4odM9ME7XhZSkzK6h1OkuRly5sX_Z6UC3pPJI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODAsInVzZXIiOjExNjI0fQ:1w3ZC0:Y9QtYVxZd60ZPgLtbKzmu3kCRmXfUvssVk_wWkx27KE"
        try:
            try:
