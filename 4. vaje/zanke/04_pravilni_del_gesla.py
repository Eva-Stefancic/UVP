...
def pravilni_del_gesla(geslo, ugibane):  
    rezultat = ""                        # Ustvarimo prazen niz, v katerega bomo sestavili prikazani del gesla.
    
    for crka in geslo:                   # Z zanko gremo čez vsako črko v geslu.
        if crka in ugibane:              # Preverimo, ali je trenutna črka med že ugibanimi črkami.
            rezultat += crka             # Če je črka že ugibana, jo dodamo v rezultat.
        else:                            # Če črka še ni bila ugibana.
            rezultat += "_"              
...
# črke. Funkcija naj vrne ugibane črke, ki se ne pojavljajo v geslu.
# Na primer:
# 
...
def nepravilni_ugibi(geslo, ugibanje):  
    izpis = ""                          # Ustvarimo prazen niz, v katerega bomo shranili napačne ugibe.
    for crka in ugibanje:               # Z zanko gremo čez vsako ugibano črko.
        if crka not in geslo:           # Preverimo, ali trenutne črke ni v geslu.
            izpis += crka               # Če črke ni v geslu, jo dodamo med napačne ugibe.
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NSwidXNlciI6MTE2MjR9:1w3ZC0:EtY5lGw0oCXgvuezboBMyj3fwT3dMhRec3beET-l1NI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NiwidXNlciI6MTE2MjR9:1w3ZC0:yHSKxXgwjQP_INkTJGkIjEI9_eWf2rT7alCmg5fbFrA"
        try:
