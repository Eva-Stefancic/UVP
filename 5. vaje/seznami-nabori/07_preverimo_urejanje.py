...
def pripravi_primer(elementi, indeksi):             # Definiramo funkcijo, ki sprejme seznam elementov in seznam indeksov.
    ...
    return primer                                   # Vrnemo sestavljen testni primer.
...
def pravilno_urejen(seznam):                       # Definiramo funkcijo, ki preveri urejenost seznama parov.
    for i in range(len(seznam)):                    # Gremo čez indekse seznama.
        if seznam[i][1] != i:                       # Preverimo, ali je drugi element para enak trenutnemu mestu.
...
# Povzetek snovi
#
# Seznam lahko vsebuje tudi pare.
# Par v Pythonu zapišemo kot terko, na primer ("c", 2).
# Terka je podobna seznamu, vendar jo zapišemo z okroglimi oklepaji.
# Do prvega elementa para dostopamo z indeksom 0.
# Do drugega elementa para dostopamo z indeksom 1.
# V tej nalogi drugi element para pove, na katerem mestu mora biti par.
# Funkcija pripravi_primer iz dveh seznamov sestavi seznam parov.
# Element in njegov indeks vzamemo z istega mesta v obeh seznamih.
# Funkcija pravilno_urejen preveri, ali je vsak par na pravilnem mestu.
# Seznam je pravilno urejen, če za vsak par velja, da je drugi element enak mestu v seznamu.
# Zanka for omogoča pregled vseh elementov oziroma indeksov v seznamu.
# Funkcija len pove dolžino seznama.
# =============================================================================
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzYyNCwidXNlciI6MTE2MjR9:1w66N9:IvFsfY31cYU0V2JS8pT61lqnpjPcEXPDNyTTHu5UEXg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzYyNSwidXNlciI6MTE2MjR9:1w66N9:FYSv7UDnYnTBPZM5rYUnBUN_yfs_Ycrfnmpvt4t4mTc"
        try:
