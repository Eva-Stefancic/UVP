...
def prvi_najvecji(sez):          # definiramo funkcijo, ki prejme seznam sez
    for el in sez[1:]:           # pregledamo vse elemente razen prvega
        if el > sez[0]:          # preverimo, ali je trenutni element večji od prvega
            return False         # če je, prvi element ni največji, zato vrnemo False
    return True                  # če večjega elementa nismo našli, vrnemo True
...
def vsi_vecji(sez1, sez2):       
    for el1 in sez1:             # pregledamo vsak element prvega seznama
        for el2 in sez2:         # za vsak el1 pregledamo elemente drugega seznama
            if el1 < el2:        # če je element iz sez1 manjši od elementa iz sez2
                return False     # pogoj ni izpolnjen, zato vrnemo False
    return True                  # če takega primera ni, vrnemo True
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzEyOCwidXNlciI6MTE2MjR9:1w66N9:QD-iOLT77fOygLAgNYMj2GDBfv0kpkqoGxbmVQkTy7k"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzEyOSwidXNlciI6MTE2MjR9:1w66N9:v4b1ICcBXb7AzArSbfoGeG4j-JJysIU7S4h5pGDnDAc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzEzMiwidXNlciI6MTE2MjR9:1w66N9:_K1PLWdqRv6KfoVa60iYuKm_Jx75trU0mWPIO_5xkEc"
        try:
