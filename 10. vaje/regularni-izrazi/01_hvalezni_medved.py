...
#  \b = nek znak, ki ga ni. brskalnik se pa obasa, kot da imamo na koncu in na zacetku vsake besede to napisano
# =============================================================================
...
#     {"oddide"}
# \w* = poljubno mnogo črk, (\w) = naredimo grupo s črko, \1 = točno ta črka se mora ponoviti, \w* = na koncu spet poljubno mnogo črk
# =============================================================================
def dvojne_crke(niz):
    rezultat = set()
    for zadetek in set(re.finditer(r"\w*(\w)\1\w*", niz)):
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzM5NywidXNlciI6MTE2MjR9:1wNr2l:Ypfgi5EnFll4aWPOYusVaCuE6yLZUQ1a44j76qvtBMk"
        try:
            Check.equal(
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzM5OSwidXNlciI6MTE2MjR9:1wNr2l:Ffno-uLwUXIKhBWUDZ6VsYLrua1y1GBb3nF_23vqWBA"
        try:
            hvalezni_medved = """Gori nekje v gorah, ne ve se več, ali je bilo pri Macigoju ali
            Naravniku, je šivala gospodinja v senci pod drevesom in zibala otroka. Naenkrat
            prilomasti - pa prej ni ničesar opazila - medved in ji moli taco, v kateri je
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwMSwidXNlciI6MTE2MjR9:1wNr2l:tvy2CEVaNnK4JoXJlgnEJ7HKJGgSNFR4k8wTW7fNxoY"
        try:
            hvalezni_medved = """Gori nekje v gorah, ne ve se več, ali je bilo pri Macigoju ali
            Naravniku, je šivala gospodinja v senci pod drevesom in zibala otroka. Naenkrat
            prilomasti - pa prej ni ničesar opazila - medved in ji moli taco, v kateri je
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwMCwidXNlciI6MTE2MjR9:1wNr2l:QgGIh-MM--q8umGmy7XDsAb8KVyXHKamXJjJTJSKTPY"
        try:
            hvalezni_medved = """Gori nekje v gorah, ne ve se več, ali je bilo pri Macigoju ali
            Naravniku, je šivala gospodinja v senci pod drevesom in zibala otroka. Naenkrat
            prilomasti - pa prej ni ničesar opazila - medved in ji moli taco, v kateri je
