...
def malce_anonimiziraj(besedilo):
    return re.sub(r"([A-ZČŠŽ][a-zčšž]+ [A-ZČŠŽ])[a-zčšž]+", inicialka, besedilo)
# =====================================================================@033406=
# 2. podnaloga
...
# =============================================================================
def samoglasnik(zadetek):
    return zadetek.group() + "p" + zadetek.group().lower()

def po_papajsko(besedilo):
    return re.sub(r"([aeiouAEIOU])", samoglasnik, besedilo)
# =====================================================================@033405=
# 3. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwNCwidXNlciI6MTE2MjR9:1wNr2l:MC0vBE4In_NQySTZCDmTCowAGWS-xYrJyhMLknONpOM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwNiwidXNlciI6MTE2MjR9:1wNr2l:X5PUK_35V-6Knrcvvi5d27oxuCYrWxtEJaoa9X-hso4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwNSwidXNlciI6MTE2MjR9:1wNr2l:VH-uu8Pb7iyKbZek37EAt02ybW_DFGVROHV_fDb8XPg"
        try:
