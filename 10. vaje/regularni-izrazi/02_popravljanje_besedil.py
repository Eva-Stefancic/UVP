...
# [abc] pomeni a ali b ali c, a(navpična črta)b(navpična črta)c ekvivalentno
# ve(navpična črta)xy(navpična črta)uvz loh tut več črk
# [^a] vse razen a
# 
# =============================================================================
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDA5MywidXNlciI6MTE2MjR9:1wNr2l:hM87IyJ8B30oT67zandJ9EyES5k-p2dbEBjJxILsvTE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwMiwidXNlciI6MTE2MjR9:1wNr2l:gv5GEob3es_Eumcz2IzrVngCMpjvg3PrIG-O9PRF1W0"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwMywidXNlciI6MTE2MjR9:1wNr2l:CG-VALsbxSy2QrsORJF_EFly5iDNf4A2kNhzhfVRxVc"
        try:
            Check.equal(
                'enote_na_konec("Cena kave je € 2, cena čaja pa €3.")',
                "Cena kave je 2 €, cena čaja pa 3 €."
