...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzMxLCJ1c2VyIjoxMTYyNH0:1wDN2V:5dZfU6TQjbufxtavTKScpUkKVQsKy947a5Um74pD208"
        try:
            test_data = [
                ('gcd(63, 35)', 7),
                ('gcd(40, 35)', 5),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzMyLCJ1c2VyIjoxMTYyNH0:1wDN2V:2Dxs4cWGvGFzqbvmrOcjmqcIrjttiTPj4VO8vcoSsSw"
        try:
            test_data = [
                ('Ulomek(5, 1).st', 5),
                ('Ulomek(5, 1).im', 1),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzMzLCJ1c2VyIjoxMTYyNH0:1wDN2V:WOsTN5GYs7aaKchBrmWtduwbS_hEYGcrjN63TYHcg9Q"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzM0LCJ1c2VyIjoxMTYyNH0:1wDN2V:sl3wY1ZsPIPhjcGo6jZmuQm5NVkXhTTWpHqejMc6piY"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzM1LCJ1c2VyIjoxMTYyNH0:1wDN2V:g03VGwne2ZfCk0ojS0xXelGLn5jAT1EtxaGtwsBSNYk"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzM2LCJ1c2VyIjoxMTYyNH0:1wDN2V:-9IZBJjzjR4s-0jUZSqzMF54XSSFHB5mEZuWNsxX2tA"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzM3LCJ1c2VyIjoxMTYyNH0:1wDN2V:_9s5RTGfpkHcloCXml5X_NPYgR3pBH-6TECGbci7HOA"
        try:
            test_data = [
                ('Ulomek(1, 6) - Ulomek(1, 4)', Ulomek(-1, 12)),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzM4LCJ1c2VyIjoxMTYyNH0:1wDN2V:t6qJ39s4hcg2cC1ftekdthgEdt7iMsqU6CgveJJI8jY"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzM5LCJ1c2VyIjoxMTYyNH0:1wDN2V:v1kKir5hOJyo_9lt4rsom6J35cw4qAS2W0Usbtb36RY"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzQwLCJ1c2VyIjoxMTYyNH0:1wDN2V:HgvKoAyQfFnaIEWBr5mpXDdga4-dEBOdZUf3XHc5Lng"
        try:
            test_data = [
