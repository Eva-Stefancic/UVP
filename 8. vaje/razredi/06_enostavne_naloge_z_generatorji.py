...
def stevke(n):
    while n > 0:
        yield n % 10      # napišeš funkcijo in print zamenjaš z yield
        n //= 10
...
def fakultete(n):
    if n == 0:
        yield 1             # yield je malo drugače kot return: return prekine funkcijo, yield pa jo nadaljuje naprej
        n = 1
    f = 1
    for i in range(1, n):
        f *= i
...
#     [20, 10, 5, 16, 8, 4, 2, 1]
#
# imamo končno zaporedje - glej druge vaje - collatzovo zaporedje se vendno konča se z 1
# =============================================================================
def collatz(n):
    while n > 1:
        yield n
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxOTMwLCJ1c2VyIjoxMTYyNH0:1wDN2V:3x_zWm44kVh6EwDzMM9_S9SoJ_BthZpGPf_7rNpXdrM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxOTMxLCJ1c2VyIjoxMTYyNH0:1wDN2V:EPUcZPU_sTMU8i4rKGdbijZaKC-OOutwq3f6s1q761U"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxOTMyLCJ1c2VyIjoxMTYyNH0:1wDN2V:o9-rUqKPbB1ToFl_srScH0wI7rcCHMAXD0FRo4XrN7o"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxOTMzLCJ1c2VyIjoxMTYyNH0:1wDN2V:qY2SOPFggEukpafGxOfF1549Rr_wcm2honV5anqKKag"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxOTM0LCJ1c2VyIjoxMTYyNH0:1wDN2V:ZH_mzS9c3ydU7VAQ6hKTEPupkZz2G2R-6yFYVhiXTxY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxOTM1LCJ1c2VyIjoxMTYyNH0:1wDN2V:zBkn6HTwM33mEsHMoteGpC_OYLv9WXZY4zKSFtXdVSE"
        try:
