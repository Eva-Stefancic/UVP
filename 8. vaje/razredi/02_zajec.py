...
# =============================================================================
    def __lt__(self, drugi):
        if self.teza < drugi.teza:
            return True
        elif self.teza == drugi.teza and self.starost < drugi.starost:
            return True
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzA2LCJ1c2VyIjoxMTYyNH0:1wDN2V:IMJlCuTZjvXJb-_hiAfK9o5qneE1iKaFmfre7i2Lj6o"
        try:
            test_data = [
                ('Zajec(5, 3).teza', 5),
                ('Zajec(5, 3).starost', 3),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzA3LCJ1c2VyIjoxMTYyNH0:1wDN2V:zzKceR0mI2qctcOli99qTn1sDfWQrYbjM-Ocn3PiVt8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzA4LCJ1c2VyIjoxMTYyNH0:1wDN2V:d89ibTk7U-TjyWh-a_Lor6-VoClKow9R2MzSBDPGiFo"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzA5LCJ1c2VyIjoxMTYyNH0:1wDN2V:DAUm4b_UXi4h687237OPE92oAJGBRZEmsGIhenUOEpI"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzEwLCJ1c2VyIjoxMTYyNH0:1wDN2V:1lSg9xB533jHmtTZZ1-q8AE7EKrcPw5ogKQJeroxMnQ"
        try:
            prav = (
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzExLCJ1c2VyIjoxMTYyNH0:1wDN2V:K87k9aSeFsCqmZDwg6G-v0nWiEyeeXkFuW6uQ5SSN4I"
        try:
