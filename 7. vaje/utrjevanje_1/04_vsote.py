...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDc0LCJ1c2VyIjoxMTYyNH0:1wBAf9:DOY3wLV4kb-batfQgCi1RsHDoWOJ9jGYxFDLYCU7cZk"
        try:
            test_data = [
                ("""vsota_kvadratov(1)""", 1),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDc1LCJ1c2VyIjoxMTYyNH0:1wBAf9:LwgE-uS_E2JOuKsLs5Ze7d13k_2uOUzgrPHzA2r8a5M"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDc2LCJ1c2VyIjoxMTYyNH0:1wBAf9:bla0s90iGxRBMw1_CmKyx0Csnm12A2XjxTwZ-yHrlnY"
        try:
            test_data = [
                ("""stevilo_clenov(2)""", 1),
                ("""stevilo_clenov(19)""", 2),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNDc3LCJ1c2VyIjoxMTYyNH0:1wBAf9:tFCG9i64NhIAW_suOBeLjE2tjfAn1QYKU5pXP6Mwid4"
        try:
            test_data = [
