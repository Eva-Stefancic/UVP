...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzgxMywidXNlciI6MTE2MjR9:1wBAf9:bgMufyqMXeTSiemg4ewDeCn9NmEYBalVAC1jMmEcHE8"
        try:
            svet_1 = [
                [False, False, False, False, False, False],
                [False, False, False, True, False, False],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzgxNCwidXNlciI6MTE2MjR9:1wBAf9:Eu_OqSKyXHG2H0TA2dfEbXfiiENb28TwYA-0ijlqZnw"
        try:
            svet_1 = [
                [False, False, False, False, False, False],
                [False, False, False, True, False, False],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzgxNSwidXNlciI6MTE2MjR9:1wBAf9:1NNTfQWI8JYy6zqXOMFOOqnbSWJhvOnEtLY6YPdXPDk"
        try:
            svet_1 = [
                [False, False, False, False, False, False],
                [False, False, False, True, False, False],
